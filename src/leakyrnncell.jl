...
@concrete struct LeakyRNNCell{T} <: AbstractRecurrentCell
...
function initialparameters(rng::AbstractRNG, rnn::LeakyRNNCell)
...
initialstates(rng::AbstractRNG, ::LeakyRNNCell) = (rng=Utils.sample_replicate(rng),)
